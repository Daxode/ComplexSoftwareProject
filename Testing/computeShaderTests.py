...
from panda3d.core import Fog, loadPrcFile
...
from panda3d.core import Vec3F, PTAVecBase3f, PTAVecBase2f
...
class FogDemo(ShowBase):
    ...
    def __init__(self):
        ...
        self.mousePos = PTAVecBase2f([0, 0])
        ...
        self.dummy.set_shader_input("mouse", self.mousePos)
